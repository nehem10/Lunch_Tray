...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewModelSubtotal((androidx.lifecycle.LiveData<java.lang.Double>) object, fieldId);
            case 2 :
    ...
    private boolean onChangeViewModelSubtotal(androidx.lifecycle.LiveData<java.lang.Double> ViewModelSubtotal, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.LiveData<java.lang.Double> viewModelSubtotal = null;
        ...
        java.lang.String viewModelTaxToString = null;
        com.example.lunchtray.model.MenuItem viewModelSideGetValue = null;
        java.lang.Double viewModelSubtotalGetValue = null;
        ...
        java.lang.String viewModelSubtotalToString = null;
        ...
        if ((dirtyFlags & 0x1bfL) != 0) {
            ...
            if ((dirtyFlags & 0x182L) != 0) {
                    ...
                    if (viewModelSubtotalGetValue != null) {
                        // read viewModel.subtotal.getValue().toString()
                        viewModelSubtotalToString = viewModelSubtotalGetValue.toString();
                    }
            }
            ...
            if ((dirtyFlags & 0x1a0L) != 0) {
                    ...
                    if (viewModelTaxGetValue != null) {
                        // read viewModel.tax.getValue().toString()
                        viewModelTaxToString = viewModelTaxGetValue.toString();
                    }
            }
        }
        // batch finished
        ...
        if ((dirtyFlags & 0x182L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.subtotal, viewModelSubtotalToString);
        }
        if ((dirtyFlags & 0x1a0L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tax, viewModelTaxToString);
        }
        if ((dirtyFlags & 0x188L) != 0) {
            // api target 1
